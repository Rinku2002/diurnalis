  ...
  return (
    <div>
        <div className='d-block mx-auto'>
            <h2 className='mt-5 descHead text-start'>Diurnalis - Journalism club</h2>
            {/* <Question/> */}
        </div>
        <div className='container mt-5'>
            <h3 className="subHeads">1.1 Purpose of Club</h3>
            ...
            <h3 className="subHeads">1.2 Domain of Club</h3>
            <p className='container border descContent'>
            ...
            <h3 className="subHeads">1.3 Context</h3>
            <p className='container border descContent'>
            ...
            <h3 className="subHeads">1.4 Executive Summary</h3>
            <p className='container border descContent'>
